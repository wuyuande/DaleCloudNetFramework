...
namespace DaleCloud.Application.CommonService
{
    ...
    public class CommonDdWorkMsg
    {
        ...
        /// <returns></returns>
        public static bool SendLicenseApplyWorkMsg(BaseProductInfoEntity model)
        {
            try
            {
                ...
                if (users.Count > 0)
                {
                    ...
                    string url = HttpHelper.GetWebSite() + "/ProductManage/ProductLicence/LicenceAudit?keyValue=" + model.T_Id;
