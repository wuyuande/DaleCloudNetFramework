...
{
    public class ComplaintsController : ControllerBaseWeixin
    {
        CrmComplaintsApp app = new CrmComplaintsApp();
        [HttpGet]
        ...
        public ActionResult SubmitForm(CrmComplaintsEntity uEntity, string keyValue)
        {
